...
- [ ] **Step 1: Créer `src/contexts/ProfileContext.tsx`**
...
- [ ] **Step 2: Wrapper App avec ProfileProvider**
...
- [ ] **Step 1: Installer composants shadcn**

```bash
pnpm dlx shadcn@latest add table select textarea badge toast
```

- [ ] **Step 2: Créer `src/features/submissions/useSubmission.ts`**
...
- [ ] **Step 3: Créer `src/features/submissions/BulkEntryTable.tsx`**
...
- [ ] **Step 4: Créer `src/features/submissions/SubmissionPage.tsx`**
...
- [ ] **Step 5: Ajouter la route dans App.tsx**
